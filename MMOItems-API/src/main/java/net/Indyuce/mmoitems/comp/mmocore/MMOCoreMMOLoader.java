...
public class MMOCoreMMOLoader extends MMOLoader {
    ...
    private static final ItemStat MAX_STELLIUM = new DoubleStat("MAX_STELLIUM", Material.ENDER_EYE, "Max Stellium", new String[]{"Additional maximum stellium."});
    private static final ItemStat ADDITIONAL_EXPERIENCE = new DoubleStat("ADDITIONAL_EXPERIENCE", Material.EXPERIENCE_BOTTLE, "Additional Experience", new String[]{"Additional MMOCore main class experience in %."});
