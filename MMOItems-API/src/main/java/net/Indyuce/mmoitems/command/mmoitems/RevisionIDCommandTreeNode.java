...
public class RevisionIDCommandTreeNode extends CommandTreeNode {
    public static final Argument<String> TYPE_OR_ALL = new Argument<>("type", (explorer, list) -> {
    ...
    static class RevIDActionCommandTreeNode extends CommandTreeNode {
        ...
        public RevIDActionCommandTreeNode(CommandTreeNode parent, String type, Function<Integer, Integer> modifier) {
            ...
            addArgument(RevisionIDCommandTreeNode.TYPE_OR_ALL);
        }
        ...
        public @NotNull CommandResult execute(CommandTreeExplorer explorer, CommandSender sender, String[] args) {
            ...
            if (failed > 0)
                ...
                sender.sendMessage(MMOItems.plugin.getPrefix() + ChatColor.GREEN + "Successfully " + cmdType + "d Rev IDs" + (type != null ? " for " + type.getName() : "") + "!");
