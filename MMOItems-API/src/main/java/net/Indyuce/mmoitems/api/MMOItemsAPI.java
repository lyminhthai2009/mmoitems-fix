...
public class MMOItemsAPI {
     ...
     */
    @NotNull
    public SkillHandler<?> getSkill(String id) {
        return Objects.requireNonNull(MythicLib.plugin.getSkills().getHandler(id), "Could not find skill with ID '" + id + "'");
    }
    ...
    public RegisteredSkill getSkillById(String id) {
        return new RegisteredSkill(getSkill(id));
    }
    ...
    /**
     * @see #castSkill(Player, SkillHandler, Map, LivingEntity, AttackMetadata)
     * @deprecated
     */
    @Deprecated
    public SkillResult castSkill(Player player, RegisteredSkill skill, @NotNull Map<String, Double> modifiers, @Nullable LivingEntity target, @Nullable AttackMetadata attackMeta) {
        return castSkill(player, skill.getHandler(), modifiers, target, attackMeta);
    }
     ...
     */
    public SkillResult castSkill(Player player, SkillHandler<?> skill, @NotNull Map<String, Double> modifiers, @Nullable LivingEntity target, @Nullable AttackMetadata attackMeta) {
