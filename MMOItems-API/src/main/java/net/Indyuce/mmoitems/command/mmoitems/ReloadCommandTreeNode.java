...
public class ReloadCommandTreeNode extends CommandTreeNode {
    ...
    public void reloadSkills(CommandSender sender) {
        ...
        sender.sendMessage(MMOItems.plugin.getPrefix() + "Successfully reloaded " + MythicLib.plugin.getSkills().getHandlers().size() + " skills.");
    }
    ...
    public void reloadMain(CommandSender sender) {
        ...
        PlayerData.getLoaded().forEach(PlayerData::reload);
    }
