	...
	public void arrangeInventory() {
		...
		if (getEditedSection().contains("ability"))
			for (String key : getEditedSection().getConfigurationSection("ability").getKeys(false)) {
				final var abilityFormat = getEditedSection().getString("ability." + key + ".type");
				var ability = abilityFormat != null
						? MythicLib.plugin.getSkills().getHandler(UtilityMethods.enumName(abilityFormat))
						: null;
