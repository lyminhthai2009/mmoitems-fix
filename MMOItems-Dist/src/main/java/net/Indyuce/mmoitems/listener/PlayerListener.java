...
public class PlayerListener implements Listener {
    ...
    public void onDeathForUpgradeLoss(@NotNull PlayerDeathEvent event) {
        ...
        // Supports NPCs
        final var playerData = PlayerData.getOrNull(event.getEntity());
        ...
        Bukkit.getScheduler().runTaskLater(MMOItems.plugin, () -> {
            ...
            DeathDowngrading.playerDeathDowngrade(playerData, event.getEntity());
        }, 3L);
    }
    ...
    public void onSessionOpen(SessionUpdateEvent event) {
        // Resolve inventory (items and stats) before anything else
